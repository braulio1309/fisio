...
class ClientController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        Client::create([
            'name'          => $request['nameClient'].' '.$request['lastname'],
    ...
    public function import_clients(Request $request)
    {
        ...
        if ($ext != 'csv') {
            ...
            foreach ($data as $key => $value) {
                ...
                if (!$validator->fails()) {
                    Client::create([
                        'name' => $value['nameClient'].' '. $value['lastname'],
                        'nameClient' => $value['nameClient'] == '' ? null : $value['nameClient'],
                        'lastname' => $value['lastname'] == '' ? null : $value['lastname'],
                        'type' => $value['type'] == '' ? null : $value['type'],
                        'giros' => $value['giros'] == '' ? null : $value['giros'],
                        'dni' => $value['rut'] == '' ? null : $value['rut'],
                        'code' => $this->getNumberOrder(),
