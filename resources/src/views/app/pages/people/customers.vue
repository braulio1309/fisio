<template>
  <div class="main-content">
    ...
    <div v-else>
      <vue-good-table mode="remote" :columns="columns" :totalRows="totalRows" :rows="clients"
  ...
  prevLabel: 'prev',
        ...
        <div slot="table-actions" class="mt-2 mb-3">
          ...
          <b-button @click="Show_import_clients()" size="sm" variant="info m-1"
            v-if="currentUserPermissions && currentUserPermissions.includes('customers_import')">
            <i class="i-Download"></i>
            {{ $t("Import_Customers") }}
          </b-button>
          <b-button @click="New_Client()" size="sm" variant="btn btn-primary btn-icon m-1"
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            ...
            <a @click="Edit_Client(props.row)"
              v-if="currentUserPermissions && currentUserPermissions.includes('Customers_edit')" title="Edit"
              v-b-tooltip.hover>
      ...
      <b-modal hide-footer size="lg" id="New_Customer" :title="editmode ? $t('Edit') : $t('Add')">
        <b-form @submit.prevent="Submit_Customer">
          <b-row>
            <!-- Customer Name -->
            <b-col md="6" sm="12">
              <validation-provider name="Name Customer" :rules="{ required: false }" v-slot="validationContext">
                <b-form-group :label="$t('CustomerName')">
                  <b-form-input aria-describedby="name-feedback"
                    label="name" v-model="client.nameClient"></b-form-input>
            ...
            <!-- Customer Name -->
            <b-col md="6" sm="12">
              <validation-provider name="Lastname Customer" :rules="{ required: false }"  v-slot="validationContext">
                <b-form-group :label="$t('Lastname')">
                  <b-form-input  aria-describedby="name-feedback"
                    label="Lastname" v-model="client.lastname"></b-form-input>
                  <b-form-invalid-feedback id="name-feedback">{{ validationContext.errors[0] }}
                  </b-form-invalid-feedback>
                </b-form-group>
              </validation-provider>
            ...
            <b-col md="6" sm="12">
              <validation-provider name="Email customer" :rules="{ required: true }" v-slot="validationContext">
                <b-form-group :label="$t('Email')">
                  <b-form-input aria-describedby="Email-feedback"
                    label="Email" v-model="client.email"></b-form-input>
                  <b-form-invalid-feedback id="Email-feedback">{{ validationContext.errors[0] }}
                  </b-form-invalid-feedback>
                  <b-alert show variant="danger" class="error mt-1" v-if="email_exist != ''">{{ email_exist }}</b-alert>
                </b-form-group>
              </validation-provider>
            </b-col>
            ...
            <!-- Customer Phone -->
            <b-col md="6" sm="12">
              <validation-provider name="Phone Customer" :rules="{ required: false }" v-slot="validationContext">
                <b-form-group :label="$t('Phone')">
                  <b-form-input aria-describedby="Phone-feedback"
                    label="Phone" v-model="client.phone"></b-form-input>
                  <b-form-invalid-feedback id="Phone-feedback">{{ validationContext.errors[0] }}
                  </b-form-invalid-feedback>
                </b-form-group>
              </validation-provider>
            </b-col>
            ...
            <!-- Customer Type -->
                <b-col md="6" class="mb-2">
                  <validation-provider name="rut" :rules="{ required: false}">
            ...
            <!-- Customer Country -->
            <b-col md="6" sm="12">
              <validation-provider name="Country customer" :rules="{ required: false }" v-slot="validationContext">
                <b-form-group :label="$t('Country')">
                  <b-form-input :state="getValidationState(validationContext)" aria-describedby="Country-feedback"
                    label="Country" v-model="client.country"></b-form-input>
                  <b-form-invalid-feedback id="Country-feedback">{{ validationContext.errors[0] }}
                  </b-form-invalid-feedback>
                </b-form-group>
              </validation-provider>
            </b-col>
            ...
            <!-- Customer Country -->
            <b-col md="6" sm="12">
              <validation-provider name="Giros" :rules="{ required: false }" v-slot="validationContext">
                <b-form-group :label="$t('Giros')">
                  <b-form-input :state="getValidationState(validationContext)" aria-describedby="Giros"
                    label="Giros" v-model="client.giros"></b-form-input>
                  <b-form-invalid-feedback id="Country-feedback">{{ validationContext.errors[0] }}
                  </b-form-invalid-feedback>
                </b-form-group>
              </validation-provider>
            ...
            <!-- Customer City -->
            <b-col md="6" sm="12">
              <validation-provider name="City Customer" :rules="{ required: false }" v-slot="validationContext">
                <b-form-group :label="$t('City')">
                  <b-form-input :state="getValidationState(validationContext)" aria-describedby="City-feedback"
                    label="City" v-model="client.city"></b-form-input>
                  <b-form-invalid-feedback id="City-feedback">{{ validationContext.errors[0] }}
                  </b-form-invalid-feedback>
                </b-form-group>
              </validation-provider>
            </b-col>
            ...
            <!-- Customer Adress -->
            <b-col md="6" sm="12">
              <validation-provider name="Adress customer" :rules="{ required: false }" v-slot="validationContext">
                <b-form-group :label="$t('Adress')">
                  <b-form-input :state="getValidationState(validationContext)" aria-describedby="Adress-feedback"
                    label="Adress" v-model="client.adresse"></b-form-input>
                  <b-form-invalid-feedback id="Adress-feedback">{{ validationContext.errors[0] }}
                  </b-form-invalid-feedback>
                </b-form-group>
              </validation-provider>
            </b-col>
            ...
            <!-- Customer Adress -->
            <b-col md="6" sm="12">
              <validation-provider name="dni" :rules="{ required: false }"  v-slot="validationContext">
                <b-form-group :state="getValidationState(validationContext)" :label="$t('RUT')">
                  <b-form-input aria-describedby="RUT"
                    label="RUT" v-model="client.dni"></b-form-input>
    ...
    <b-modal ok-only ok-title="Cancel" size="md" id="importClients" :title="$t('Import_Customers')">
      <b-form @submit.prevent="Submit_import" enctype="multipart/form-data">
        <b-row>
          ...
          <b-col md="6" sm="12">
            <b-button :href="'/import/exemples/import_clients.csv'" variant="info" size="sm" block>{{
                $t("Download_exemple")
            }}</b-button>
          </b-col>
...
export default {
  ...
  methods: {
    ...
    clients_PDF() {
      ...
      let columns = [
        { title: "Name", dataKey: "nameClient" },
        { title: "Lastname", dataKey: "lastname" },
        { title: "Type", dataKey: "type" },
        { title: "giros", dataKey: "giros" },
        { title: "RUT", dataKey: "dni" },
    ...
    Create_Client() {
      ...
      axios
        .post("clients", {
          name: this.client.nameClient+' '+this.client.lastname,
          nameClient: this.client.nameClient,
          lastname: this.client.lastname,
          giros: this.client.giros,
