...
Route::post('create-transaction-webpay', 'PaymentWebpayController@createTransaction');

// Login
Route::post('login-customer', "AuthController@getAccessToken");
Route::get('logout-customer', "AuthController@logout");

// Register customer
Route::post('register-customer', "AuthController@customerRegister");
//Route::post('update-avatar', "")

// Reset password
Route::post('search-token-passwd', "PasswordResetController@returnToken");
...
// Routes Categpories
    Route::get('get-categories', 'CategorieController@getCategories');
    Route::get('categories/{id}/products', 'CategorieController@getCategoriesProducts');

// Routes products
    Route::get('new-products', 'ProductsController@newProducts');
    Route::get('featured-products', 'ProductsController@newProducts');
    Route::get('products/details/{id}', 'ProductsController@productDetails');
    Route::get('productsAll', 'ProductsController@allProducts');

// Route Favorites
    Route::post('add-favorite-products', 'ProductsController@addFavoriteProducts');
    Route::get('favorite/products/{id}', 'ProductsController@listFavoriteProducts');
    Route::delete('favorite/delete/{id}', 'ProductsController@deleteFavoriteProduct');


// Routes Categpories
    Route::get('get-brands', 'BrandsController@getBrands');
    Route::get('brands/{id}/products', 'BrandsController@getBrandProducts');

// Routes Address
    Route::post('add-address', 'AddressController@addAddress');
    Route::get('get-address/{id}', 'AddressController@getAddress');
    Route::post('updated-address/{id}', 'AddressController@editAddress');
...
// Route warehouse
    Route::get('get-warehouse', 'WarehouseController@Get_Warehouses');

// Route shopping cart
    Route::post('add-cart', 'CartController@addProducts');
    Route::get('get-cart/{id}', 'CartController@show');
    Route::post('upload-cart-local', 'CartController@uploadCartLocal');
    Route::post('delete-cart-item', 'CartController@deleteItemCart');


// User Avatar
Route::post('updated-avatar', 'UserController@uploadAvatar');
